    ...
    <div class="signright">
        <div class="signform">
            ...
            <form id="signup"class="logform">
                <input type="text" class="input_form" placeholder="First name" name="user-firstname" required><br><br>
                ...
                <span>Already have an account? </span><a href="./login.html" style="color: deepskyblue; text-decoration: none;">Login</a>
